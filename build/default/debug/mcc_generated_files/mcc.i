...
# 14 "mcc_generated_files/serial.h"
...
_Bool SerialLineAvailable(void);

_Bool SerialReadLine(char *dst, uint8_t max_len);

_Bool SerialSendString(const char *text);

_Bool SerialIsTxBusy(void);
# 61 "mcc_generated_files/mcc.h" 2
# 1 "mcc_generated_files/motor.h" 1
# 12 "mcc_generated_files/motor.h"
typedef enum
{
    MOTOR_DIR_CW = 0,
    MOTOR_DIR_CCW = 1
